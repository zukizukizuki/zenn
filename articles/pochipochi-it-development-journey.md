...
普段はWindowsを使っているため、iOS開発のためにMacを購入する必要がありました。

- **高額な初期投資**: Mac miniでも10万円以上の出費
- **操作の違い**: WindowsユーザーにとってmacOSの操作は慣れが必要
- **開発環境の構築**: Homebrew、Xcode、各種ツールのセットアップ
...
インフラエンジニアとしてのセキュリティ知識が、モバイルアプリ開発でも大いに役立ちました。
